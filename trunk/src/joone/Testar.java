 ...
 */
public class Testar implements NeuralNetListener, NeuralValidationListener {
    
    NeuralNet net;
    long startms;
    private static String filePath = "joone/org/joone/samples/engine/validation";
    ...
    private void initialize(String path) {
        ...
        org.joone.engine.Monitor mon = net.getMonitor();
